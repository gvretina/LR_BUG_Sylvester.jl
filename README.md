...
This project reproduces and illustrates the **Low-Rank BUG method**, which iteratively constructs a low-rank approximation to the solution by following the ideas of the BUG integrator as introduced by G.Ceruti and C.Lubich [https://doi.org/10.1007/s10543-021-00873-0](https://doi.org/10.xxxx/jcla.2025.12345).
...
- Is unfortunately part of a WIP, and there are a lot of references towards TTNs.  
